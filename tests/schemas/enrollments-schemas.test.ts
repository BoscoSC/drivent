    ...
    describe('street', () => {
      ...
      it('should return error if street is not a string', () => {
        ...
        const { error } = createEnrollmentSchema.validate({
          ...
          address: {
            ...input.address,
            street: faker.number.int(maxInt4Value),
          },
        });
    ...
    describe('city', () => {
      ...
      it('should return error if city is not a string', () => {
        ...
        const { error } = createEnrollmentSchema.validate({
          ...
          address: {
            ...input.address,
            city: faker.number.int(maxInt4Value),
          },
        });
    ...
    describe('number', () => {
      ...
      it('should return error if number is not a string', () => {
        ...
        const { error } = createEnrollmentSchema.validate({
          ...
          address: {
            ...input.address,
            number: faker.number.int(maxInt4Value),
          },
        });
    ...
    describe('state', () => {
      ...
      it('should return error if state is not a string', () => {
        ...
        const { error } = createEnrollmentSchema.validate({
          ...
          address: {
            ...input.address,
            state: faker.number.int(maxInt4Value),
          },
        });
    ...
    describe('neighborhood', () => {
      ...
      it('should return error if neighborhood is not a string', () => {
        ...
        const { error } = createEnrollmentSchema.validate({
          ...
          address: {
            ...input.address,
            neighborhood: faker.number.int(maxInt4Value),
          },
        });
    ...
    describe('addressDetail', () => {
      ...
      it('should return error if addressDetail is not a string', () => {
        ...
        const { error } = createEnrollmentSchema.validate({
          ...
          address: {
            ...input.address,
            addressDetail: faker.number.int(maxInt4Value),
          },
        });
